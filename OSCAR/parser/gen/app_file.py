...
for app in apps:
    ...
    gr.printFile("        break;")
    gr.printFile("    case IOC_E_OK:")
    gr.printFile("        PrintText(\"[ErrorHook]: IOC_E_OK\\r\\n\");")
    gr.printFile("        break;")
    gr.printFile("    case IOC_E_NOK:")
    gr.printFile("        PrintText(\"[ErrorHook]: IOC_E_NOK\\r\\n\");")
    gr.printFile("        break;")
    gr.printFile("    case IOC_E_LENGTH:")
    gr.printFile("        PrintText(\"[ErrorHook]: IOC_E_LENGTH\\r\\n\");")
    gr.printFile("        break;")
    gr.printFile("    case IOC_E_LIMIT:")
    gr.printFile("        PrintText(\"[ErrorHook]: IOC_E_LIMIT\\r\\n\");")
    gr.printFile("        break;")
    gr.printFile("    case IOC_E_LOST_DATA:")
    gr.printFile("        PrintText(\"[ErrorHook]: IOC_E_LOST_DATA\\r\\n\");")
    gr.printFile("        break;")
    gr.printFile("    case IOC_E_NO_DATA:")
    gr.printFile("        PrintText(\"[ErrorHook]: IOC_E_NO_DATA\\r\\n\");")
    gr.printFile("        break;")
