    ...
    .dw    #_Reserved_EI ; INT1    ; reserve for Inter-processor INT(not in use)
    .dw    #_Reserved_EI ; INT2    ; reserve for Inter-processor INT(not in use)
    .dw    #_Reserved_EI ; INT3    ; reserve for Inter-processor INT(not in use)
    .dw    #_Dummy_EI    ; INT4    
    .dw    #_Reserved_EI ; INT5    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT6    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT7    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Dummy_EI    ; INT8    
    .dw    #_Dummy_EI    ; INT9    
    .dw    #_Dummy_EI    ; INT10    
    .dw    #_Dummy_EI    ; INT11    
    ...
    .dw    #_Dummy_EI    ; INT31    
    .dw    #_Dummy_EI    ; INT32    
    .dw    #_Reserved_EI ; INT33    ; 20220307/not-used/INTRLIN30   /RLIN30-interrupt
    .dw    #_INTRLIN30UR0 ; INT34   ; 20220307/  IN-USE/INTRLIN30UR0/RLIN30 transmit interrupt 
    .dw    #_Reserved_EI ; INT35    ; 20220307/not-used/INTRLIN30UR1/RLIN30-receive-complete-interrupt
    .dw    #_Reserved_EI ; INT36    ; 20220307/not-used/INTRLIN30UR2/RLIN30-status-interrupt
    .dw    #_ScheduleKernelISR ; INT37   ; INT37 core 0 
    .dw    #_ScheduleKernelISR ; INT38   ; INT38 core 1 
    .dw    #_Reserved_EI ; INT39    ; autosar reserved
    .dw    #_INTWDTA0 ; INT40   ; INTWDTA0 
    .dw    #_INTWDTA1 ; INT41   ; INTWDTA1 
    .dw    #_Dummy_EI    ; INT42    
    .dw    #_Dummy_EI    ; INT43    ; user ISR I001
    .dw    #_ISR_I002_LAUNCHER    ; INT44 
    .dw    #_Dummy_EI    ; INT45    
    .dw    #_Dummy_EI    ; INT46    
    .dw    #_Dummy_EI    ; INT47    
    .dw    #_Dummy_EI    ; INT48    
    ...
    .dw    #_Dummy_EI    ; INT67    
    .dw    #_Dummy_EI    ; INT68    
    .dw    #_Dummy_EI    ; INT69    ; user ISR I004
    .dw    #_Dummy_EI    ; INT70    
    .dw    #_Dummy_EI    ; INT71    
    .dw    #_Dummy_EI    ; INT72    
    .dw    #_Dummy_EI    ; INT73    
    ...
    .dw    #_Dummy_EI    ; INT91    
    .dw    #_Dummy_EI    ; INT92    
    .dw    #_ISR_I003_LAUNCHER    ; INT93 
    .dw    #_ISR_I005_LAUNCHER    ; INT94 
    .dw    #_ISR_I006_LAUNCHER    ; INT95 
    .dw    #_Dummy_EI    ; INT96    
    .dw    #_Dummy_EI    ; INT97    
    .dw    #_Dummy_EI    ; INT98    
    .dw    #_Dummy_EI    ; INT99    
    ...
    .dw    #_Dummy_EI    ; INT102    
    .dw    #_Dummy_EI    ; INT103    
    .dw    #_Reserved_EI ; INT104    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT105    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT106    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT107    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT108    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT109    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Dummy_EI    ; INT110    
    .dw    #_Dummy_EI    ; INT111    
    .dw    #_Dummy_EI    ; INT112    
    .dw    #_Dummy_EI    ; INT113    
    ...
    .dw    #_Dummy_EI    ; INT126    
    .dw    #_Dummy_EI    ; INT127    
    .dw    #_Dummy_EI    ; INT128    ; user ISR I101
    .dw    #_ISR_I102_LAUNCHER    ; INT129 
    .dw    #_ISR_I103_LAUNCHER    ; INT130 
    .dw    #_Dummy_EI    ; INT131    
    .dw    #_Dummy_EI    ; INT132    
    .dw    #_Dummy_EI    ; INT133    
    .dw    #_Dummy_EI    ; INT134    
    .dw    #_Dummy_EI    ; INT135    
    .dw    #_Reserved_EI ; INT136    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT137    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT138    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT139    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT140    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT141    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Dummy_EI    ; INT142    
    .dw    #_Dummy_EI    ; INT143    
    .dw    #_Dummy_EI    ; INT144    
    .dw    #_Dummy_EI    ; INT145    
    ...
    .dw    #_Dummy_EI    ; INT170    
    .dw    #_Dummy_EI    ; INT171    
    .dw    #_Reserved_EI ; INT172    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Dummy_EI    ; INT173    
    .dw    #_Dummy_EI    ; INT174    
    .dw    #_Dummy_EI    ; INT175    
    .dw    #_Dummy_EI    ; INT176    
    ...
    .dw    #_Dummy_EI    ; INT184    
    .dw    #_Dummy_EI    ; INT185    
    .dw    #_Dummy_EI    ; INT186    ; user ISR I104
    .dw    #_ISR_I105_LAUNCHER    ; INT187 
    .dw    #_ISR_I106_LAUNCHER    ; INT188 
    .dw    #_Dummy_EI    ; INT189    
    .dw    #_Dummy_EI    ; INT190    
    .dw    #_Dummy_EI    ; INT191    
    .dw    #_Dummy_EI    ; INT192    
    ...
    .dw    #_Dummy_EI    ; INT214    
    .dw    #_Dummy_EI    ; INT215    
    .dw    #_Reserved_EI ; INT216    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Dummy_EI    ; INT217    
    .dw    #_Dummy_EI    ; INT218    
    .dw    #_Dummy_EI    ; INT219    
    .dw    #_Dummy_EI    ; INT220    
    ...
    .dw    #_Dummy_EI    ; INT234    
    .dw    #_Dummy_EI    ; INT235    
    .dw    #_Reserved_EI ; INT236    ; 20220515/not-used/INTRLIN35   /RLIN35-interrupt
    .dw    #_INTRLIN35UR0 ; INT237   ; 20220515/  IN-USE/INTRLIN35UR0/RLIN35 transmit interrupt 
    .dw    #_Reserved_EI ; INT238    ; 20220515/not-used/INTRLIN30UR1/RLIN35-receive-complete-interrupt
    .dw    #_Reserved_EI ; INT239    ; 20220515/not-used/INTRLIN30UR2/RLIN35-status-interrupt
    .dw    #_Dummy_EI    ; INT240    
    .dw    #_Dummy_EI    ; INT241    
    .dw    #_Dummy_EI    ; INT242    
    .dw    #_Dummy_EI    ; INT243    
    ...
    .dw    #_Dummy_EI    ; INT288    
    .dw    #_Dummy_EI    ; INT289    
    .dw    #_Reserved_EI ; INT290    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT291    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT292    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT293    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT294    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT295    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT296    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT297    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Dummy_EI    ; INT298    
    .dw    #_Dummy_EI    ; INT299    
    .dw    #_Dummy_EI    ; INT300    
    .dw    #_Dummy_EI    ; INT301    
    ...
    .dw    #_Dummy_EI    ; INT322    
    .dw    #_Dummy_EI    ; INT323    
    .dw    #_Reserved_EI ; INT324    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT325    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Dummy_EI    ; INT326    
    .dw    #_Dummy_EI    ; INT327    
    .dw    #_Dummy_EI    ; INT328    
    .dw    #_Dummy_EI    ; INT329    
    ...
    .dw    #_Dummy_EI    ; INT333    
    .dw    #_Dummy_EI    ; INT334    
    .dw    #_Reserved_EI ; INT335    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT336    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT337    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT338    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT339    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT340    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT341    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT342    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT343    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT344    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT345    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT346    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT347    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT348    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT349    ; DO-NOT-USE, Reserved by hardware(f1h)
    .dw    #_Reserved_EI ; INT350    ; DO-NOT-USE, Reserved by hardware(f1h)
